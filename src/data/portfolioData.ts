...
export const portfolioData: PortfolioData = {
  ...
  education: [
    ...
    },
    {
      ...
      period: "2020",
      description: "Key subjects: Combined Mathematics, Physics, Chemistry."
    }
  ],
  skills: [
    {
  ...
  certificates: [
    { id: "cert-1", title: "AutoCAD Workshop", issuer: "Highway Engineering Society of KDU", date: "2025", url: "/Portfolio/certificates/CAD_Workshop_Certificate.pdf" },
    { id: "cert-2", title: "Floating City Design Competition", issuer: "ASCE Student Chapter of NSBM Green University", date: "2025", url: "/Portfolio/certificates/Floating_City_Design_Workshop.pdf" },
    { id: "cert-3", title: "Design of High-Rise Buildings Course", issuer: "Structural Design Institute", date: "2026", url: "/Portfolio/certificates/Design_of_High_Rise_Buildings_SAP2000.pdf" },
    { id: "cert-4", title: "Applied Machine Learning in Civil Engineering", issuer: "University of Moratuwa", date: "2026", url: "/Portfolio/certificates/Data Science & Analytics.pdf" },
    { id: "cert-5", title: "Basics of Engineering Management", issuer: "Alison", date: "2026", url: "/Portfolio/certificates/Basics_of_Engineering_Management.pdf" },
    { id: "cert-6", title: "Site Management Safety Training Scheme (SMSTS)", issuer: "Alison", date: "2026", url: "/Portfolio/certificates/Site_Management_Safety_Training.pdf" },
    { id: "cert-7", title: "Fundamental of MATLAB (Self-Paced Training)", issuer: "Math works", date: "2024", url: "/Portfolio/certificates/MATLAB_Fundamentals_Course.pdf" },
    { id: "cert-8", title: "Smarter, Stronger, Greener, AI enabled energy infrastructure", issuer: "gapHQ & Engineers Without Borders", date: "2026", url: "/Portfolio/certificates/WS2_34_Workshop_Certificate.pdf" },
    ...
    { id: "cert-10", title: "Introduction to Prestressed concrete design", issuer: "ICE - UK (SLAICE)", date: "2026", url: "/Portfolio/certificates/Introduction_to_Prestressed_Concrete.pdf" },
    { id: "cert-11", title: "Introduction to Highway design", issuer: "ICE - UK (SLAICE)", date: "2025", url: "/Portfolio/certificates/Introduction_to_Highway_Design.pdf" },
    { id: "cert-12", title: "Discover how structures withstand and extremes", issuer: "IAPS SL Chapter & gapHQ", date: "2026" },
    { id: "cert-13", title: "Accelerating manuscript preparation using AI", issuer: "IAPS SL Chapter & gapHQ", date: "2026", url: "/Portfolio/certificates/AI_Manuscript_Preparation_Webinar.pdf" },
    { id: "cert-14", title: "AI in Construction Technology", issuer: "SDI", date: "2025", url: "/Portfolio/certificates/AI_in_Construction_Technology_Webinar.pdf" },
    { id: "cert-15", title: "Pre-Cast Housing Solutions – Immediate Response for Disasters", issuer: "SDI", date: "2026", url: "/Portfolio/certificates/Precast_Housing_Solutions_Seminar.pdf" },
    ...
    { id: "cert-18", title: "AI for Beginners", issuer: "Online Certification", date: "2026", url: "/Portfolio/certificates/AI for Beginners.pdf" },
    { id: "cert-19", title: "Elements of AI", issuer: "MinnaLearn & University of Helsinki", date: "2026", url: "/Portfolio/certificates/certificate-elements-of-ai.png" },
    { id: "cert-20", title: "Concrete Mix Design and Rheology", issuer: "Technical Seminar", date: "2026", url: "/Portfolio/certificates/Concrete_Mix_Design_and_Rheology.pdf" },
    { id: "cert-21", title: "Critical Thinking in the AI Era", issuer: "Online Certification", date: "2026", url: "/Portfolio/certificates/Critical Thinking in the AI Era.pdf" },
    { id: "cert-22", title: "Cybersecurity ADBI E-Learning", issuer: "Asian Development Bank Institute", date: "2026", url: "/Portfolio/certificates/Cybersecurity-ADBI-E-Learning.pdf" },
    { id: "cert-23", title: "DAP320", issuer: "Online Certification", date: "2026", url: "/Portfolio/certificates/DAP320.pdf" },
    { id: "cert-24", title: "Geotechnical Site Investigation", issuer: "Technical Seminar", date: "2026", url: "/Portfolio/certificates/Geotechnical_Site_Investigation.pdf" },
    { id: "cert-25", title: "ICE Student Membership", issuer: "Institution of Civil Engineers", date: "2024", url: "/Portfolio/certificates/ICE_Student_Membership.pdf" },
    { id: "cert-26", title: "Introduction to Structural Mechanics", issuer: "Technical Course", date: "2026", url: "/Portfolio/certificates/Introduction_to_Structural_Mechanics.pdf" },
    { id: "cert-27", title: "Mathematical Society Membership", issuer: "Mathematical Society", date: "2026", url: "/Portfolio/certificates/Mathematical_Society_Membership.pdf" }
  ]
};
