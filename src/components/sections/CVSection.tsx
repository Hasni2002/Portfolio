  ...
  return (
    <section id="cv" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="glass-panel rounded-2xl border border-slate-900/10 dark:border-white/10 overflow-hidden flex flex-col lg:flex-row shadow-2xl">
          {/* Sidebar / Tabs */}
          <div className="lg:w-64 bg-surface/50 border-r border-slate-900/10 dark:border-white/10 p-6 flex flex-row lg:flex-col gap-2 overflow-x-auto">
              ...
              <button
                ...
                className={`text-left px-4 py-3 rounded-xl font-medium transition-all flex items-center justify-between whitespace-nowrap ${
                  activeTab === tab 
                    ...
                    : 'text-slate-600 dark:text-slate-400 hover:bg-slate-900/5 dark:bg-white/5 hover:text-white'
                }`}
              >
          ...
          <div className="flex-1 p-8 lg:p-12 min-h-[400px]">
            <AnimatePresence mode="wait">
              {activeTab === 'overview' && (
                ...
                >
                  <h3 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white border-b border-slate-900/10 dark:border-white/10 pb-4">Professional Summary</h3>
                  <div className="prose prose-invert max-w-none text-slate-700 dark:text-slate-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                      <div className="bg-surface/50 p-6 rounded-xl border border-slate-900/5 dark:border-white/5">
                      ...
                      <div className="bg-surface/50 p-6 rounded-xl border border-slate-900/5 dark:border-white/5">
                        <p className="text-sm text-slate-600 dark:text-slate-400 mb-1">Degree</p>
              ...
              {activeTab === 'skills' && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h3 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white border-b border-slate-900/10 dark:border-white/10 pb-4">Skills Overview</h3>
                      ...
                      <div key={category.title}>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {category.skills.map(skill => (
                            <span key={skill.name} className="px-3 py-1.5 bg-surface rounded-lg border border-slate-900/5 dark:border-white/5 text-sm font-medium text-slate-700 dark:text-slate-300 hover:border-accent/50 transition-colors cursor-default">
                              {skill.name}
                            </span>
                          ))}
                        </div>
